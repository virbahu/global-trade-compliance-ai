...
> **AI-powered global trade compliance with automated HS classification, denied party screening, license determination, and FTA certificate of origin**
...
**Global Trade Compliance AI** represents the cutting edge of logistics technology applied to supply chain management. This implementation combines rigorous academic methodology from **Professor Morris Cohen** (Wharton) with production-ready Python code designed for enterprise deployment.
...
├── 📄 global_trade_compliance_ai.py     # Core implementation
...
git clone https://github.com/virbahu/global-trade-compliance-ai.git
...
# Run the solution
python global_trade_compliance_ai.py
```

### Docker (Optional)

```bash
docker build -t global-trade-compliance-ai .
docker run -it global-trade-compliance-ai
```
...
```python
from global_trade_compliance_ai import *
